...
import { employeeData } from "./areas-data.js";
...
export default function CellSelectionAreas() {
    ...
    return (_jsxs("div", { className: "areas-demo", children: [_jsx(AreasPanel, { selections: selections }), _jsx("div", { className: "areas-grid-container", children: _jsx(Grid, { columns: columns, rowSource: ds, cellSelectionMode: "multi-range", cellSelections: selections, onCellSelectionChange: setSelections }) })] }));
}
if (import.meta.vitest) {
    ...
    test("should display range selections across pin boundaries without overlapping incorrectly", async () => {
        const screen = await r.render(_jsx(CellSelectionAreas, {}));
        await wait();
