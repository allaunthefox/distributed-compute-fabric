...
export default function CellSelectionAreas() {
    ...
    return (_jsx("div", { className: "areas-demo", children: _jsx("div", { className: "areas-grid-container", children: _jsx(Grid, { columns: columns, rowSource: ds, cellSelectionMode: "multi-range" }) }) }));
}
