...
export default function GridHeightGrid() {
    ...
    return (_jsxs("div", { style: { width: "500px", height: "500px", display: "grid", gridTemplateRows: "auto 1fr" }, children: [_jsx("div", { style: { height: "50px", width: "100%" } }), _jsx("div", { style: { width: "100%" }, children: _jsx(Grid, { styles: { viewport: { style: { border: "1px solid black" } } }, columns: columns, rowSource: source }) })] }));
}
if (import.meta.vitest) {
    ...
    test("Should render the grid with a flex height", async () => {
        const screen = await r.render(_jsx(GridHeightGrid, {}));
        await wait(100);
